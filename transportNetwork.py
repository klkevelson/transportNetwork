...
class Bus(Vehicles):
    def __init__(self,wheel, driver, color,speed,fuel,number,capacity,size ):
        Vehicles.__init__(self, wheel, driver, color,speed,fuel ,number,capacity)
        self.busSize = size
...
def addPeople():
    ...
    chooseTransportation = input("Please choose a mode of transportation \n"+
...
print("\nHey, welcome to the Transport Network ;)\n\t ")
